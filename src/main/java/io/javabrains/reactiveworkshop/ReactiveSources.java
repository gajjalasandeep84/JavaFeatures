...
/**
 * This class is a source of reactive streams used in the exercises. DO NOT
 * MODIFY THIS CODE
 *
...
public class ReactiveSources {
	...
	public static Flux<User> userFlux() {
		return Flux
				.just(new User(1, "Lionel", "Messi"), new User(2, "Cristiano", "Ronaldo"),
						new User(2, "Diego", "Maradona"), new User(4, "Zinedine", "Zidane"),
						new User(5, "Jürgen", "Klinsmann"), new User(6, "Gareth", "Bale"))
				.delayElements(Duration.ofSeconds(1));
	}
